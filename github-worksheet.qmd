...
1.  Working with myself crossing different devices
2.  Working collaboratively with team members up-to-date
3.  Keep track of previous work
...
use_git_config(user.name = "Effie Gao", user.email = "xtm613@usask.ca")
```
